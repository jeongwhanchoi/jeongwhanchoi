...
- (May 16, 2026) A paper I co-authored, "[One Sequential Recommendation Model Pretrained from Synthetic Priors Predicts Multiple Datasets](https://dl.acm.org/doi/10.1145/3770855.3818142)," was accepted to KDD 2026 (Research Track).
...
- (Apr 9, 2026) Invited to serve as an Area Chair for the [GFM workshop at ICML 2026](https://sites.google.com/view/gfmicml-2026).
- (Mar 25, 2026) Invited to serve as a reviewer for NeurIPS 2026.
- (Mar 16, 2026) Selected as the 2026 Jang Young-Sil Fellow Program (Excellence Track), awarded by KAIST's Office of Research Affairs. The fellowship supports outstanding postdoctoral researchers throughout 2026.
- (Mar 1, 2026) Invited to serve as General Chair of LoG 2026.
- (Jan 26, 2026) "[Learning Posterior Predictive Distributions for Node Classification from Synthetic Graph Priors](https://openreview.net/forum?id=FmxRzlu0rT)" was accepted in ICLR 2026!

<details>
<summary>📚 Archived news</summary>

- (Nov 19, 2025) I presented "Tackling Over-smoothing and Over-squashing in Deep Learning on Graphs" at the "[Making Decisions with AI](https://pnu-ds.github.io/)" seminar, Pusan National University.
...
- (Oct 29, 2025) Our paper "[Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs](https://www.arxiv.org/abs/2511.13010)" has been accepted as an oral presentation at *AAAI 2026*!
...
- (July 5, 2025) Invited as a reviewer for KDD 2026 (first cycle).
- (June 19, 2025) Invited to be a PC member for WSDM 2026.
- (June 11, 2025) I have been recognized as an Outstanding Reviewer (Top 10%) for KDD 2025 (February Cycle).
...
- (Apr 8, 2025) Invited to be a PC member for ECAI 2025.
- (Mar 3, 2025) Invited to be a Web Chair for CIKM 2025!
- (Mar 2, 2025) Paper Digest announced that "Graph Neural Controlled Differential Equations for Traffic Forecasting" ranked 13th among the most influential papers at AAAI 2022.
- (Feb 27, 2025) As a Ph.D. technical research personnel, I completed a military training program in February!
- (Feb 17, 2025) Invited to be a reviewer for NeurIPS 2025.
- (Jan 25, 2025) Invited to be a reviewer for [Transactions on Machine Learning Research (TMLR)](https://jmlr.org/tmlr/).
...
- (Dec 3, 2024) I won a 2024 [Qualcomm Innovation Fellowship](assets/award/QIFK2024.pdf)!
...
- (Oct 29, 2024) I am honored to receive the [First Prize (Paper Track on Business Idea Competition)](assets/award/KFTC.jpeg) by the Korea Financial Telecommunications & Clearings Institute (금융결제원).
...
- (Jul 12, 2024) I was awarded the "Merit Academic Paper Award" by Yonsei University for my research "Blurring-Sharpening Process Models for Collaborative Filtering", which was presented at SIGIR 2023.
...
- (Jan 15, 2024) I was awarded the "Best Paper Award" by Yonsei University for my research "GREAD: Graph Neural Reaction-Diffusion Networks", which was presented at ICML 2023.
...
- (Nov 24, 2023) GREAD: Graph Neural Reaction-Diffusion Networks was invited to the "Top Conference Session" at KSC 2023.
...
- (Oct 27, 2023) HyperNetwork Approximating Future Parameters for Time Series Forecasting under Temporal Drifts was accepted in [NeurIPS 2023 Workshop on Distribution Shifts (DistShift)](https://sites.google.com/view/distshift2023/home?authuser=0).
- (Sep 1, 2023) I started an alternative military service as a Ph.D. technical research personnel.
- (Aug 23, 2023) QoS-Aware Graph Contrastive Learning for Web Service Recommendation was accepted in [APSEC 2023](https://conf.researchr.org/home/apsec-2023).
- (Aug 10, 2023) Blurring-Sharpening Process Models for Collaborative Filtering was invited to the "Top Conference Session" at KCC 2023.
- (Jun 22, 2023) I have joined as a contributor to the Graph User Group (GUG) community.
- (Jun 13, 2023) GREAD was invited for SEA-CROGS, where Sandia National Labs and Pacific Northwest National Labs are collaborating to solve scientific problems with deep learning. Prof. Noseong Park, my research advisor, presented the paper on June 27 via weekly webinars.
- (May 29, 2023) Graph Neural Rough Differential Equations for Traffic Forecasting was accepted in ACM Transactions on Intelligent Systems and Technology (TIST) (IF=10.489).
- (May 12, 2023) My research work (LT-OCF) is featured in the "Top 23 Python recommender-system Projects" and "Top 14 collaborative-filtering Open-Source Projects" on LibHunt.
- (Apr 25, 2023) GREAD: Graph Neural Reaction-Diffusion Networks was accepted in ICML 2023.
- (Apr 6, 2023) Blurring-Sharpening Process Models for Collaborative Filtering was accepted in SIGIR 2023.
- (Jan 6, 2023) Climate Modeling with Neural Advection-Diffusion Equation was accepted in Knowledge and Information Systems (IF=2.531).
- (Sep 28, 2022) Prediction-based One-shot Dynamic Parking Pricing was accepted in CIKM 2022.
- (Jun 12, 2022) Graph Neural Controlled Differential Equations for Traffic Forecasting was selected for the Innovation Awards at Yonsei University.
- (Apr 7, 2022) Graph Neural Controlled Differential Equations for Traffic Forecasting was invited to the "Top Conference Session" at KCC 2022.
- (Feb 18, 2022) Graph Neural Controlled Differential Equations for Traffic Forecasting was selected for oral presentation in AAAI 2022. The top 4.21% (380/9,020) of papers were selected for oral presentation in AAAI 2022.
- (Dec 8, 2022) Graph Neural Controlled Differential Equations for Traffic Forecasting was accepted in AAAI 2022.
- (Nov 23, 2022) Linear, or Non-Linear, That is the Question! was accepted in WSDM 2022.
- (Dec 13, 2021) Our IEEE ICDM 2021 paper "Climate Modeling with Neural Diffusion Equations" has been invited for journal extension in Knowledge and Information Systems (KAIS).
- (Aug 31, 2021) Climate Modeling with Neural Diffusion Equations was accepted in ICDM 2021.
- (Aug 9, 2021) LT-OCF: Learnable-Time ODE-based Collaborative Filtering was accepted in CIKM 2021.
...
| Repo | Paper | Venue | Stars |
|---|---|---|---|
| [BSPM](https://github.com/jeongwhanchoi/BSPM) | Blurring-Sharpening Process Models for Collaborative Filtering | SIGIR 2023 | ![](https://img.shields.io/github/stars/jeongwhanchoi/BSPM?style=social) |
| [LT-OCF](https://github.com/jeongwhanchoi/LT-OCF) | LT-OCF: Learnable-Time ODE-based Collaborative Filtering | CIKM 2021 | ![](https://img.shields.io/github/stars/jeongwhanchoi/LT-OCF?style=social) |
...
|---|---|---|
| [convert-ppt-to-pdf](https://github.com/jeongwhanchoi/convert-ppt-to-pdf) | Batch-convert PPT/PPTX to PDF via macOS Automator | ![](https://img.shields.io/github/stars/jeongwhanchoi/convert-ppt-to-pdf?style=social) |
---

You can check both my [CV](https://jeongwhanchoi.com/cv.pdf) and [CV of Failures](https://github.com/jeongwhanchoi/CV_of_Failures/blob/main/CV_of_Failures.pdf).
For more information about me and my work, please visit my [homepage](https://www.jeongwhanchoi.com) and latest updates!